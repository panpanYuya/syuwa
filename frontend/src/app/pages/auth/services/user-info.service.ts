...
export class UserInfoService {
  ...
  public completedUserUpdate(token: string): Observable<CompletedUserUpdateDto> {
    return this.http.post<CompletedUserUpdateDto>(ApiConst.SLASH + ApiConst.API + ApiConst.SLASH + ApiConst.USER + ApiConst.SLASH + ApiConst.UPDATE + ApiConst.SLASH + ApiConst.COMPLETE + ApiConst.SLASH + token, '')
      .pipe(
  ...
  public editUserInfo(editUserInfoRequestDto: EditUserInfoRequestDto): Observable<EditUserResultResponseDto> {
    return this.http.post<EditUserResultResponseDto>(ApiConst.SLASH + ApiConst.API + ApiConst.SLASH + ApiConst.USER + ApiConst.SLASH + ApiConst.UPDATE , editUserInfoRequestDto)
      .pipe(
        catchError(this.handleError)
      );
  }
  ...
  public findEditUserInfoByUserId(userId: number): Observable<EditUserInfoResponseDto> {
    return this.http.get<EditUserInfoResponseDto>(ApiConst.SLASH + ApiConst.API + ApiConst.SLASH + ApiConst.USER + ApiConst.SLASH + ApiConst.EDIT + ApiConst.SLASH + userId)
      .pipe(
        catchError(this.handleError)
      );
  }
